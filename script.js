...
function restart(){
    ...
    document.getElementById('restart-gamescreen').classList.remove('d-none');
}
...
function checkForWin() {
    ...
    if (fields[0] == fields[3] && fields[3] == fields[6] && fields[0]) {
        winner = fields[0];
        document.getElementById('line-4').style.transform = 'scaleY(1) rotate(90deg)';
    }
    if (fields[1] == fields[4] && fields[4] == fields[7] && fields[1]) {
        winner = fields[1];
        document.getElementById('line-5').style.transform = 'scaleY(1) rotate(90deg)';
    }
    if (fields[2] == fields[5] && fields[5] == fields[8] && fields[2]) {
        winner = fields[2];
        document.getElementById('line-6').style.transform = 'scaleY(1) rotate(90deg)';
    }
    ...
    if (winner) {
        ...
        document.getElementById('restart-gamescreen').classList.add('d-none');
    }
}